...
#
"""
Executable Python script that samples the positions of hard disks in a periodic box using the reflective event-chain
...
"python3 ECMC_reflective.py 2 2 0.28 crystal --chain_time 80.0 --n_chains 1 --n_samples 10".
